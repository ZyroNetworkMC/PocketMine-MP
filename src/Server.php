...
class Server{
	...
	public function __construct(
		...
		try{
			...
			$splash = "\n\n";
			foreach([
				KnownTranslationFactory::pocketmine_server_url_discord("{$highlight}https://discord.zyro.network{$reset}"),
				...
				KnownTranslationFactory::pocketmine_server_url_donations("{$highlight}PayPal: @aayankarasu{$reset}"),
